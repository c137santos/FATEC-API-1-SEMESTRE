...
def busca_grupos_alunos_turma(id):
    # Passo 1: Buscar grupos da turma
    grupos = busca_grupos_turma(id)
    # Passo 2: Buscar alunos associados a esses grupos
    alunos = busca_grupos_alunos(grupos)
    # Passo 3: Buscar os nomes dos alunos
    nomes_alunos = busca_nomes_alunos(alunos)
    # Retornar os grupos e os nomes dos alunos associados a eles
    return grupos, nomes_alunos
