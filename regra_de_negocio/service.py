...
def criar_turma(dados_nova_turma):
    ...
    resposta, quantidade_ciclos, duracao_ciclo = gerenciador_turmas.criacao_turma(dados_nova_turma, nova_turma_id, turmas)
    gerenciador_ciclos.criar_ciclo_turma(duracao_ciclo, nova_turma_id, quantidade_ciclos)
    return resposta
